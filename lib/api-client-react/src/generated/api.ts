 ...
 */
export const uploadDocument = async (uploadInput: UploadInput, options?: Parameters<typeof customFetch>[1]): Promise<UploadResult> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UploadDocumentMutationVariables = {data: BodyType<UploadInput>}
